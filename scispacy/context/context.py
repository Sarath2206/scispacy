...
from ..common.scispacy_matcher import ScispacyMatcher
...
@Language.factory("scispacy_context")
class ConText:
    """
    ...
    def __init__(
        ...
        span_group_name: str = "scispacy_spans",
    ):
        """
        ...
        self.DEFAULT_RULES_FILEPATH = "/Users/sarath/.cursor-tutor/Translations/trail_context/lib/python3.9/site-packages/scispacy/context_rules.json"

        self.__matcher = ScispacyMatcher(
            nlp,
            name=name,
